...
export default function CardProduct({ title, text, price, href = '#' }) {// eslint-disable-line
  ...
  return (
    <div className="hover:scale-105 hover:-translate-y-3 transition-all max-w-xl mb-10  justify-center bg-gradient-to-r from-primary-700 to-primary-600 rounded-lg col-span-12  md:col-span-6 xl:col-span-3 z-0 overflow-hidden grid">
      <Link href={href}>
